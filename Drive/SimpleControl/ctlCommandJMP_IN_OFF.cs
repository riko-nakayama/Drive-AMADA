...
{
    public partial class ctlCommandJMP_IN_OFF : UserControl
    {
        #region 定数

        public const Int32 ProgID = 0x0c;

        public const string Command = "JMP_IN_OFF";

        public readonly string Help = UserText.CtlCommandJMP_IN_OFF_HELP1 + Environment.NewLine +
                                      UserText.CtlCommandJMP_IN_OFF_HELP2 + Environment.NewLine +
                                      UserText.CtlCommandJMP_IN_OFF_HELP3;
        ...
        private Int32 iMODE_J2 = 0;         // FLAG_J2
        ...
        public string MnemonicCode
        {
            get
            {
                return Command + " MODE_J2=" + iMODE_J2.ToString() + " DiveStep=" + iDiveStep.ToString() +
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void rdoMODE_J2_CheckedChanged(object sender, EventArgs e)
        {
        ...
        {
            System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(ctlCommandJMP_IN_OFF));

            grpMODE_J2.Font = (Font)resources.GetObject("grpMODE_J2.Font");
            ...
            rdoInstructionPos.Font = (Font)resources.GetObject("grrdoInstructionPosadientLabel2.Font");
            ...
            grpMODE_J2.Text = resources.GetString("grpMODE_J2.Text");
            ...
            txtInputNumber.Text = resources.GetString("txtInputNumber.Text");
