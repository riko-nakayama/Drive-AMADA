...
{
    partial class ctlCommandJMP_IN_OFF
    {
        /// <summary> 
        /// 必要なデザイナ変数です。
        /// </summary>
        ...
        {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ctlCommandJMP_IN_OFF));
			...
			this.grpMODE_J2 = new System.Windows.Forms.GroupBox();
			...
			// grpMODE_J2
			// 
			this.grpMODE_J2.AccessibleDescription = null;
			this.grpMODE_J2.AccessibleName = null;
			resources.ApplyResources(this.grpMODE_J2, "grpMODE_J2");
			this.grpMODE_J2.BackgroundImage = null;
			this.grpMODE_J2.Controls.Add(this.rdoWaitTime);
			this.grpMODE_J2.Controls.Add(this.rdoInstructionPosInp);
			this.grpMODE_J2.Controls.Add(this.rdoInstructionPos);
			this.grpMODE_J2.Controls.Add(this.rdoUNCONDWait);
			this.grpMODE_J2.Name = "grpMODE_J2";
			this.grpMODE_J2.TabStop = false;
			// 
			// rdoWaitTime
			// 
			...
			this.rdoWaitTime.CheckedChanged += new System.EventHandler(this.rdoMODE_J2_CheckedChanged);
			// 
			...
			this.rdoInstructionPosInp.CheckedChanged += new System.EventHandler(this.rdoMODE_J2_CheckedChanged);
			// 
			// rdoInstructionPos
			// 
			...
			this.rdoInstructionPos.CheckedChanged += new System.EventHandler(this.rdoMODE_J2_CheckedChanged);
			// 
			// rdoUNCONDWait
			// 
			...
			this.rdoUNCONDWait.CheckedChanged += new System.EventHandler(this.rdoMODE_J2_CheckedChanged);
			// 
			// gradientLabel1
			// 
			...
			this.Controls.Add(this.grpMODE_J2);
			...
			this.Font = null;
			this.Name = "ctlCommandJMP_IN_OFF";
			this.Load += new System.EventHandler(this.ctlCommandJMP_IN_Load);
			this.grpMODE_J2.ResumeLayout(false);
			this.grpMODE_J2.PerformLayout();
        ...
        private System.Windows.Forms.GroupBox grpMODE_J2;
