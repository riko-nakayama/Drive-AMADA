...
{
    partial class ctlCommandJMP_STS
    {
        /// <summary> 
        /// 必要なデザイナ変数です。
        /// </summary>
        ...
        {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ctlCommandJMP_STS));
			this.label2 = new System.Windows.Forms.Label();
			this.txtDiveStep = new System.Windows.Forms.TextBox();
			this.txtServoSTSBit = new System.Windows.Forms.TextBox();
			...
			this.rdoOneJump = new System.Windows.Forms.RadioButton();
			this.rdoZeroJump = new System.Windows.Forms.RadioButton();
			...
			// txtServoSTSBit
			// 
			this.txtServoSTSBit.AccessibleDescription = null;
			this.txtServoSTSBit.AccessibleName = null;
			resources.ApplyResources(this.txtServoSTSBit, "txtServoSTSBit");
			this.txtServoSTSBit.BackgroundImage = null;
			this.txtServoSTSBit.Name = "txtServoSTSBit";
			this.txtServoSTSBit.Leave += new System.EventHandler(this.txtServoSTSBit_Leave);
			this.txtServoSTSBit.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.txtServoSTSBit_KeyPress);
			// 
			// label3
			// 
			...
			this.groupBox1.Controls.Add(this.rdoOneJump);
			this.groupBox1.Controls.Add(this.rdoZeroJump);
			this.groupBox1.Name = "groupBox1";
			this.groupBox1.TabStop = false;
			// 
			// rdoOneJump
			// 
			this.rdoOneJump.AccessibleDescription = null;
			this.rdoOneJump.AccessibleName = null;
			resources.ApplyResources(this.rdoOneJump, "rdoOneJump");
			this.rdoOneJump.BackgroundImage = null;
			this.rdoOneJump.Font = null;
			this.rdoOneJump.Name = "rdoOneJump";
			this.rdoOneJump.UseVisualStyleBackColor = true;
			this.rdoOneJump.CheckedChanged += new System.EventHandler(this.rdoThreshold_CheckedChanged);
			// 
			// rdoZeroJump
			// 
			this.rdoZeroJump.AccessibleDescription = null;
			this.rdoZeroJump.AccessibleName = null;
			resources.ApplyResources(this.rdoZeroJump, "rdoZeroJump");
			this.rdoZeroJump.BackgroundImage = null;
			this.rdoZeroJump.Checked = true;
			this.rdoZeroJump.Font = null;
			this.rdoZeroJump.Name = "rdoZeroJump";
			this.rdoZeroJump.TabStop = true;
			this.rdoZeroJump.UseVisualStyleBackColor = true;
			this.rdoZeroJump.CheckedChanged += new System.EventHandler(this.rdoThreshold_CheckedChanged);
			// 
			// label4
			// 
			...
			this.Controls.Add(this.txtServoSTSBit);
			this.Controls.Add(this.label3);
			this.Controls.Add(this.txtDiveStep);
			this.Controls.Add(this.label2);
			this.Font = null;
			this.Name = "ctlCommandJMP_STS";
			this.Load += new System.EventHandler(this.ctlCommandJMP_STS_Load);
        ...
        private System.Windows.Forms.TextBox txtServoSTSBit;
        ...
        private System.Windows.Forms.RadioButton rdoOneJump;
        private System.Windows.Forms.RadioButton rdoZeroJump;
