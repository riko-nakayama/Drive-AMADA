namespace Motion_Designer
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.tbtnVibration = new System.Windows.Forms.ToolStripButton();
			...
			// tbtnVibration
			// 
			resources.ApplyResources(this.tbtnVibration, "tbtnVibration");
			this.tbtnVibration.Name = "tbtnVibration";
			this.tbtnVibration.Click += new System.EventHandler(this.tbtnVibration_Click);
			this.tbtnVibration.MouseEnter += new System.EventHandler(this.Control_MouseEnter);
			this.tbtnVibration.MouseHover += new System.EventHandler(this.Control_MouseHover);
			// 
			// MainForm
			// 
		...
		private System.Windows.Forms.ToolStripButton tbtnVibration;
	}
}
